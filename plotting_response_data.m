function plotting_response_data(meas_data, model_output)
    ...
    position_ID_1 = meas_data{1}(:,1);
    
    position_ID_2 = meas_data{2}(:,1);
    
    %meas_potential = ;
    %}
    meas_potential =  meas_data{1}(:,2);
    meas_current_density =  meas_data{2}(:,2);
    
    
    output_potential =  model_output{1}(:,end);
    output_current_density = model_output{2}(:,end);
    ...
    xticks(ax1, position_ID_1(1:5:end));
    xticklabels(ax1, uint64(position_ID_1(1:5:end)));
